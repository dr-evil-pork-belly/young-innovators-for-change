...
import { taxLine, trustBadges, ORG } from '@/content/org';
...
const TIERS = [
  {
    ...
    featured: false,
    impact: 'Funds a first-cohort classroom of 25 students',
    perks: [
    ...
    roi: '25 students x 8 weeks = 200 student-hours funded',
  },
  {
    id:       'series-a',
    icon:     Shield,
    ...
    featured: true,
    impact:   'Would fund a pilot across 3 schools',
    perks: [
    ...
    roi: 'Would fund 125 students across 3 schools for one semester',
  },
  {
    id:       'founding',
    icon:     Crown,
...
const FAQS = [
  {
    q: 'What exactly is the curriculum?',
  ...
  },
  {
    ...
    a: 'We are placing our first classroom pilots in the San Gabriel Valley and have not yet run a cohort, so we will not claim districts we do not serve. Funding at this stage buys the first classrooms rather than an expansion into an existing footprint. Partners can help select the schools we approach first.',
  },
  {
  ...
  },
  {
    ...
    a: `${taxLine() ?? ''} You will receive a written acknowledgment for your records. We recommend consulting your tax advisor for specific guidance.`,
  },
  {
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-6">
              {[
                { icon: Users,    val: '36 wks',   lbl: 'Curriculum Built' },
                { icon: BookOpen, val: '5+',       lbl: 'Active Districts' },
                { icon: Award,    val: ORG.taxStatus.status === 'determined' ? '501(c)(3)' : 'Nonprofit', lbl: ORG.taxStatus.status === 'determined' ? 'Tax Deductible' : 'Mission Driven'  },
            ...
            <div>
              ...
              <Reveal delay={0.2} className="mt-10">
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...trustBadges().map(label => ({ icon: Shield, label })),
